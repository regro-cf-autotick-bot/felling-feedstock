...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/felling-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12222&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/felling-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `felling` can be installed with:

```
conda install felling
```

It is possible to list all of the versions of `felling` available on your platform with:
